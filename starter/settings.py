...
SECRET_KEY = 'f0)9bw==j&6byk60nhn^qlf*0!s%8#199-_2r+()*=2(+@40!p'
...
#     # '/Users/Kyle/Documents/Kyle/Programming/Python/startproj/templates',
# )
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(__file__), '..', 'static'), 
    # '/Users/Kyle/Documents/Kyle/Programming/Python/startproj/static',
)
